...
const features = [
  ...
  },
  {
    title: "24/7 Support",
    description:
      "Our dedicated support team is here to help you every step of the way. Whether you need assistance with setting up your account, understanding your performance reports, or simply have questions about our process, we’re here to ensure your experience with Capital Vault is seamless and successful.",
    type: "image",
    ...
    >
      <div className="px-8">
        <h2 className="font-extrabold text-4xl lg:text-6xl tracking-tight mb-12 md:mb-24">
          ...
          <span className="bg-neutral text-neutral-content px-2 md:px-4 ml-1 md:ml-1.5 leading-tight text-center">
